...
const editRecruiterSchema = z.object({
  firstName: z
    .string()
    .trim()
...
function EditRecruiterModal({
  ...
  const {
    ...
    resolver: zodResolver(editRecruiterSchema),
    defaultValues: {
      firstName: "",
      lastName: "",
      email: "",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-2xl border border-slate-800 bg-slate-900 shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 px-6 py-5">
          <div>
            <h2 className="text-xl font-semibold text-white">Edit Recruiter</h2>

            <p className="mt-1 text-sm text-slate-400">
              Update recruiter account information.
            </p>
          </div>
