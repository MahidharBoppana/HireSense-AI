...
const createHiringManagerSchema = z
  .object({
    firstName: z
      .string()
      .trim()
...
function CreateHiringManagerModal({ isOpen, onClose, onSubmit, isSubmitting }) {
  ...
  const {
    ...
    resolver: zodResolver(createHiringManagerSchema),
    defaultValues: {
      firstName: "",
      lastName: "",
      email: "",
      ...
      <div className="w-full max-w-lg rounded-2xl border border-slate-800 bg-slate-900 shadow-2xl">
        ...
        >
          ...
          <div className="flex justify-end gap-3 border-t border-slate-800 pt-5">
            ...
            >
              {isSubmitting ? "Creating..." : "Create Hiring Manager"}
            </button>
          </div>
        </form>
      </div>
...
export default CreateHiringManagerModal;
